    ...
    try {
      const response = await fetch('http://localhost:5000/api/users/register', {
        ...
        body: JSON.stringify({
          ...
          email: values.phone + '@fake.com', // <-- No email field, use phone as fake email
          password: values.phone, // Or prompt for password if required
        ...
        <div className="container mx-auto max-w-2xl">
          <Card>
            <CardHeader className="text-center">
              ...
              <CardDescription>
                Fill in your details to join our lifesaving community
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Form {...form}>
